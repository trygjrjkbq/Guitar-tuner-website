...
if (document.getElementById("welcomeHeader") != null)
{
    ...
    document.getElementById("info").textContent="Welcome to our guitar tuner project, the website is currenlty still in development, but most parts are already functional.\r\n";
